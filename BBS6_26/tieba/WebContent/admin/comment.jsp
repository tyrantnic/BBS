...
<base href="<%=basePath%>"/>
  ...
  function select() {
		...
		for (var i = 0; i < id.length; i++) {
			if(id[i].checked){
			ids=ids+"cid="+id[i].value+"&";	
			}
		}
		location.href="${pageContext.request.contextPath}/deleteCommentServlet?"+ids;
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="admin/member.jsp">用户列表</a></dd>
                </dl>
            </li>
    ...
    <div style="padding: 15px;">
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
              <form class="layui-form" action="${pageContext.request.contextPath}/findNoteCommentServlet" method="get">
                <div class="layui-form-item" style="text-align:center;">
                  <div class="layui-inline">
                    <div class="layui-input-inline">
                      <input autocomplete="off" class="layui-input" placeholder="请输入帖子标题查询 " type="text" name="key" >
                    </div>
                  </div>
              ...
              <table class="layui-table">
                  ...
                  <c:forEach items="${requestScope.comments}" var="comment" varStatus="s">
                   <tr>
                      <td><input type="checkbox" name="id" value="${comment.cid}" ></td>
                      <td><img src="${comment.avatar}" style="width: 42px; height: 42px; border-radius:100%;"/></td>
                      <td>${comment.myname }</td>
                      <td>${comment.time }</td>
                      <td>${comment.topic}</td>
                      <td>${comment.content}</td>
                      <td class="text-center">
                        <div class="layui-btn-group">
                          <a class="layui-btn layui-btn-xs layui-btn-danger" href="${pageContext.request.contextPath}/deleteCommentServlet?cid=${comment.cid}" onclick="return checkdel()">
