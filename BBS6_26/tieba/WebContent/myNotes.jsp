		...
		<div class="main layui-clear">
			<div class="wrap">
				<div class="content" style="margin-right:0">
					...
					<span> <a
						href="${pageContext.request.contextPath}/index.jsp">全部留言</a> <a
						href="${pageContext.request.contextPath}/moreViewNoteServlet">最多浏览</a>

						<a href="${pageContext.request.contextPath}/moreComNoteServlet">最近热议</a>
						<a href="${pageContext.request.contextPath}/moreRewardNoteServlet">最多悬赏</a>
						<a href="${pageContext.request.contextPath}/myNotesServlet"
						class="tab-this">我的留言</a>
					</span>
					...
					<form action="${pageContext.request.contextPath}/searchNoteServlet" class="fly-search" name="searchform" >
						...
						<a href="add.jsp" class="layui-btn jie-add">发布留言</a>
					</div>

					<ul class="fly-list">
						<c:forEach items="${requestScope.mynotes}" var="note" varStatus="s">
